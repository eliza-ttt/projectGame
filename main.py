...
class GameManager:
    ...
    def draw_score(self):
        ...
        player_score_rect = player_score.get_rect(midleft=(screen_width / 2 + 30, screen_height / 2))
        opponent_score_rect = opponent_score.get_rect(midright=(screen_width / 2 - 30, screen_height / 2))
